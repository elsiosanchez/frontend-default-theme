...
export default defineComponent({
  ...
  setup() {
    ...
    const isComponentRender = computed(() => {
      if (currentOptions.value === language.t('pointOfSales.customer.newBusinessPartner')) return () => import('@theme/components/ADempiere/Form/NewVPOS/HeaderOrder/Customer/NewCustomer.vue')
      if (currentOptions.value === language.t('pointOfSales.customer.listBusinessPartners')) return () => import('@theme/components/ADempiere/Form/NewVPOS/HeaderOrder/Customer/ListCustomer.vue')
      if (currentOptions.value === language.t('pointOfSales.customer.updateBusinessPartner')) return () => import('@theme/components/ADempiere/Form/NewVPOS/HeaderOrder/Customer/NewCustomer.vue')
      if (currentOptions.value === language.t('form.pos.order.BusinessPartnerCreate.address.addNewAddress')) return () => import('@theme/components/ADempiere/Form/NewVPOS/HeaderOrder/Customer/NewCustomer.vue')
      return () => import('@theme/components/ADempiere/Form/NewVPOS/HeaderOrder/Customer/ListCustomer.vue')
    })
